...
namespace GunNutChapterOne
{
	internal class GunNutChapterOneSettings : ModSettings
    {
        ...
        public void DoSettingsWindowContents(Rect settingsCanvas)
        {
            ...
            list.ColumnWidth = (settingsCanvas.width - 17) / 2; // Subtract 17 for gap between columns
            list.Begin(settingsCanvas);
           
            Text.Font = GameFont.Medium;
            list.Label("settings_GN_EnableHeader");
            list.GapLine();

            Text.Font = GameFont.Small;
            list.Label("settings_GN_EnableDescription");
            list.Gap();
            ...
            Text.Font = GameFont.Medium;
            list.Label("settings_GN_EnableNickNameHeader");
            list.GapLine();

            Text.Font = GameFont.Small;
            list.Label("settings_GN_EnableNickNameDescription");
            list.Gap();
